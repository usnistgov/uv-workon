...
project = "uv-workon"
copyright = "2025, William P. Krekelberg"  # ruff:ignore[builtin-variable-shadowing]
...
release = version = uv_workon.__version__
...
html_theme_options = {
    ...
    # "canonical_url": "",
    "repository_url": f"https://github.com/{github_username}/uv-workon",
...
htmlhelp_basename = "uv_workondoc"
...
def linkcode_resolve(domain: str, info: dict[str, Any]) -> str | None:
    ...
    # fmt: off
    fn = os.path.relpath(fn, start=Path(uv_workon.__file__).parent)
    # fmt: on

    return f"https://github.com/{github_username}/uv-workon/blob/{html_context['github_version']}/src/uv_workon/{fn}{linespec}"
